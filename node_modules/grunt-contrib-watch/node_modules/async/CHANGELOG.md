...
# v2.2.0
- Added `groupBy`, and the `Series`/`Limit` equivalents, analogous to [`_.groupBy`](//lodash.com/docs#groupBy) ([#1364](https://github.com/caolan/async/issues/1364))
...
- Added [BootStrap scrollspy](//getbootstrap.com/javascript/#scrollspy) to docs to highlight in the sidebar the current method being viewed  ([#1289](https://github.com/caolan/async/issues/1289), [#1300](https://github.com/caolan/async/issues/1300))
...
- Added `transform`, analogous to [`_.transform`](//lodash.com/docs#transform) ([#892](https://github.com/caolan/async/issues/892))
