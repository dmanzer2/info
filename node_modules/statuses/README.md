...
The status codes are primarily sourced from //www.iana.org/assignments/http-status-codes/http-status-codes-1.csv.
Additionally, custom codes are added from //en.wikipedia.org/wiki/List_of_HTTP_status_codes.
...
[node-version-image]: //img.shields.io/badge/node.js-%3E%3D_0.6-brightgreen.svg?style=flat
...
[downloads-image]: //img.shields.io/npm/dm/statuses.svg?style=flat
