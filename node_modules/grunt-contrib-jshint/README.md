...
Task targets, files and options may be specified according to the grunt [Configuring tasks](//gruntjs.com/configuring-tasks) guide.

For more explanations of the lint errors JSHint will throw at you please visit [jslinterrors.com](//jslinterrors.com/).
...
[JSHint documentation]: //www.jshint.com/docs/
...
See also: [Writing your own JSHint reporter.](//jshint.com/docs/reporters/)
...
#### Wildcards
In this example, running `grunt jshint:all` (or `grunt jshint` because `jshint` is a [multi task](//gruntjs.com/configuring-tasks#task-configuration-and-targets)) will lint the project's Gruntfile as well as all JavaScript files in the `lib` and `test` directories and their subdirectories, using the default JSHint options.
...
Task submitted by ["Cowboy" Ben Alman](//benalman.com/)
