...
For an example implementation view the [connect-redis](//github.com/visionmedia/connect-redis) repo.
...
[Knex.js](//knexjs.org/), which is a SQL query builder for PostgreSQL, MySQL, MariaDB, SQLite3, and Oracle.
...
[![Github Stars][session-rethinkdb-image] session-rethinkdb][session-rethinkdb-url] A [RethinkDB](//rethinkdb.com/)-based session store.
