...
* If the url in the `homepage` field does not specify a protocol, then http is assumed. For example, `myproject.org` will be changed to `//myproject.org`.
...
normalize-package-data is released under the [BSD 2-Clause License](//opensource.org/licenses/MIT).  
