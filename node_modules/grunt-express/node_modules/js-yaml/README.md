...
[![Build Status](https://secure.travis-ci.org/nodeca/js-yaml.png)](//travis-ci.org/nodeca/js-yaml)

[Online Demo](//nodeca.github.com/js-yaml/)


This is an implementation of [YAML](//yaml.org/), a human friendly data
serialization language. Started as [PyYAML](//pyyaml.org/) port, it was
...
[YAML tag discussion](//pyyaml.org/wiki/YAMLTagDiscussion) and
[YAML types repository](//yaml.org/type/).
