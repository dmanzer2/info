...
exports.bool = {
  enforcing: {
     ...
     * JavaScript](//javascriptweblog.wordpress.com/2011/02/07/truth-equality-and-javascript/)
     * by Angus Croll.
     */
    eqeqeq      : true,
     ...
     * specification](//es5.github.io/). This includes allowing reserved
     ...
     * loops](//javascriptweblog.wordpress.com/2011/01/04/exploring-javascript-for-in-loops/)
     * by Angus Croll.
     */
    forin       : true,
     ...
     * standardized. (See
     * [#11.1.4](//www.ecma-international.org/ecma-262/5.1/#sec-11.1.4) and
     * [#11.1.5](//www.ecma-international.org/ecma-262/5.1/#sec-11.1.5).)
     * Now, they help to prevent the same [visual
     * ambiguities](//www.ecma-international.org/ecma-262/5.1/#sec-7.9.2)
  ...
  relaxing: {
     ...
     * Semicolons](//blog.izs.me/post/2353458699/an-open-letter-to-javascript-leaders-regarding)
     * by Isaac Schlueter and [JavaScript Semicolon
     * Insertion](//inimino.org/~inimino/blog/javascript_semicolons).
     */
    asi         : true,
    ...
    */
     ...
     *   Harmful](//yuiblog.com/blog/2006/04/11/with-statement-considered-harmful/)
     */
    withstmt    : true,
     ...
     *   6](//www.ecma-international.org/ecma-262/6.0/index.html)
     *
  ...
  environments: {
     ...
     * [MooTools](//mootools.net/) JavaScript framework.
     */
    mootools    : true,

    /**
     * This option defines globals exposed by
     * [CouchDB](//couchdb.apache.org/). CouchDB is a document-oriented
    ...
    /**
     * This option defines globals exposed by the [jQuery](//jquery.com/)
     * JavaScript library.
     */
    jquery      : true,
     ...
     * of the Node runtime environment. [Node.js](//nodejs.org/) is a
     ...
     * framework](//qunitjs.com/).
     */
    qunit       : true,

    /**
     * This option defines globals available when your code is running inside
     * of the Rhino runtime environment. [Rhino](//www.mozilla.org/rhino/)
     ...
     * library](//documentup.com/arturadib/shelljs).
     */
    shelljs     : true,

    /**
     * This option defines globals exposed by the
     * [Prototype](//www.prototypejs.org/) JavaScript framework.
     */
    prototypejs : true,

    /**
     * This option defines globals exposed by the [YUI](//yuilibrary.com/)
     ...
     * [Mocha unit testing framework](//mochajs.org/).
     */
    mocha       : true,
     ...
     * Host](//en.wikipedia.org/wiki/Windows_Script_Host).
     */
    wsh         : true,
     ...
     * tool](//browserify.org/) to build a project.
     */
    browserify  : true,
     ...
     * of the PhantomJS runtime environment. [PhantomJS](//phantomjs.org/)
...
exports.val = {
   ...
   * Configuration](//jshint.com/docs/#inline-configuration).
   */
  globals      : false,
   ...
   * Wikipedia](//en.wikipedia.org/wiki/Cyclomatic_complexity).
   */
  maxcomplexity: false,
   ...
   * Hoisting](//www.adequatelygood.com/2010/2/JavaScript-Scoping-and-Hoisting)
   * by Ben Cherry.
   */
  latedef      : false,
   ...
   *    specification](//www.ecma-international.org/ecma-262/5.1/index.html).
   *    This includes allowing reserved keywords as object properties.
   *  - `6` - To tell JSHint that your code uses [ECMAScript
   *    6](//www.ecma-international.org/ecma-262/6.0/index.html) specific
