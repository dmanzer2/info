...
Install it using [npm](//github.com/isaacs/npm):

    $ npm install temp

Or get it directly from:
//github.com/bruce/node-temp
...
great for scripts and [Grunt tasks](//gruntjs.com/), it's not so great for long-running
...
// For use with ConTeXt, //wiki.contextgarden.net
...
If you want to use the module with [Grunt](//gruntjs.com/), make sure you
...
For more information, see the [Grunt FAQ](//gruntjs.com/frequently-asked-questions#why-doesn-t-my-asynchronous-task-complete).
...
//github.com/bruce/node-temp/issues
