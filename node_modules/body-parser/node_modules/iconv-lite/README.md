 ...
 * Doesn't need native code compilation. Works on Windows and in sandboxed environments like [Cloud9](//c9.io).
 * Used in popular projects like [Express.js (body_parser)](https://github.com/expressjs/body-parser), 
   [Grunt](//gruntjs.com/), [Nodemailer](//www.nodemailer.com/), [Yeoman](//yeoman.io/) and others.
...
Multibyte encodings are generated from [Unicode.org mappings](//www.unicode.org/Public/MAPPINGS/) and [WHATWG Encoding Standard mappings](//encoding.spec.whatwg.org/). Thank you, respective authors!
