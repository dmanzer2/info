...
==================
  ...
  * Added new [documentation](//senchalabs.github.com/connect)
  ...
  * Rewrote session middleware. The session API now allows for
    ...
    Click to view the new [session api](//senchalabs.github.com/connect/middleware-session.html).
  ...
  * Added [limit()](//senchalabs.github.com/connect/middleware-limit.html) middleware
  * Added [profiler()](//senchalabs.github.com/connect/middleware-profiler.html) middleware
  * Added [responseTime()](//senchalabs.github.com/connect/middleware-responseTime.html) middleware
...
==================
  ...
  * Removed connect(1), it is now [spark(1)](//github.com/senchalabs/spark)
  ...
  * Removed _jsonrpc_ middleware, use [visionmedia/connect-jsonrpc](//github.com/visionmedia/connect-jsonrpc)
...
==================
  ...
  * Revamped the api, view the [Connect documentation](//extjs.github.com/Connect/index.html#Middleware-Authoring) for more info (hover on the right for menu)
  * Added [extended api docs](//extjs.github.com/Connect/api.html)
